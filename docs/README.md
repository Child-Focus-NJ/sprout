...
- **[MVP Plan](mvp-plan.md)** — What to build for the Feb 20 demo, day-by-day build sequence, and demo script
- **[User Stories](user-stories/)** — Original user stories describing what the system needs to do
