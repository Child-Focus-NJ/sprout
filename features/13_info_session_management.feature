Feature: Manage Information Sessions
    ...
    Background:
        Given the following information sessions exist:
            ...
            | 10       | Zoom                 | December Info Session         | 2025-12-08 10:00:00 |
        ...
        And "John Doe" has signed up for an information session with date Mar 06, 2027 and time 06:00 PM
        ...
        Scenario: Removing an attendee from an information session 
            ...
            And the status for "John Doe" should change from "Registered for information session" to "Inquiry"

        Scenario: An attendee cancels their sign up for an information session 
            Given "John Doe" cancels their sign up for information session with date Mar 06, 2027 and time 06:00 PM
            Then "John Doe" should not appear on the list of attendees for information session with date Mar 06, 2027 and time 06:00 PM
            And the status for "John Doe" should change from "Registered for information session" to "Inquiry"

        Scenario: Deleting an information session
